...
const JobDetails = () => {
  ...
  const { data, isLoading } = useJobByIdQuery(id); //{ pollingInterval: 1000 } for real time update
      ...
      <div className='col-span-9 mb-10'>
        ...
        <div>
          <div>
            ...
            <div className='text-primary my-2'>
              ...
              {queries?.map(({ question, email, reply, id }) => (
                <div key={id}>
                  ...
                  {/* this reply button for only employer */}
            ...
            {/* question input */}
            <form onSubmit={handleSubmit(handleQestion)}>
